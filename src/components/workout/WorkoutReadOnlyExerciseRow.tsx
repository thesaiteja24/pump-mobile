...
interface WorkoutReadOnlyExerciseRowProps {
  exercise: TemplateExercise | WorkoutHistoryExercise | any // simplistic union for now
  group: any | null
}

export function WorkoutReadOnlyExerciseRow({ exercise, group }: WorkoutReadOnlyExerciseRowProps) {
...
export default WorkoutReadOnlyExerciseRow
