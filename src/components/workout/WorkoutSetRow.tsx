...
import { RPESelectionModal } from '@/components/modals/RPESelectionModal'
import { SetTypeSelectionModal } from '@/components/modals/SetTypeSelectionModal'
...
function WorkoutSetRowInternal({
  setId,
  exerciseType,
  exerciseRestMode,
  notesExpanded = false,
...
export const WorkoutSetRow = memo(WorkoutSetRowInternal)
