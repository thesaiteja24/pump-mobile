 ...
 */
export interface WorkoutElapsedTimeWallClockProps {
  /**
 ...
 */
export interface WorkoutElapsedTimeAccumulatedProps {
  /**
...
/**
 * Props for the WorkoutElapsedTime component.
 *
 * Exactly one mode must be used:
 * - Wall clock mode → provide `startTime`
 * - Accumulated mode → provide `baseSeconds` and/or `runningSince`
 */
export type WorkoutElapsedTimeProps = WorkoutElapsedTimeWallClockProps | WorkoutElapsedTimeAccumulatedProps
 ...
 * @example
 * // Wall clock mode
 * <WorkoutElapsedTime startTime={new Date()} />
 *
 * @example
 * // Accumulated mode
 * <WorkoutElapsedTime baseSeconds={120} runningSince={Date.now()} />
 */
export function WorkoutElapsedTime(props: WorkoutElapsedTimeProps) {
...
export default WorkoutElapsedTime
