 ...
 */
export type HabitHeatMapLayout = 'vertical' | 'horizontal' | 'fill'
 ...
 */
export type HabitHeatMapFillLayout = 'row' | 'column'

interface HabitHeatMapProps {
  values: HabitHeatMapEntry[]
   ...
   */
  fillLayout?: HabitHeatMapFillLayout
}
