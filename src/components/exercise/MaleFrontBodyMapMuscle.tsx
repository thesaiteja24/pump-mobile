...
const SVGComponent = ({ fills, onPressMuscle }: Props) => {
  ...
  return (
    <Svg viewBox="0 0 660.46 1206.46" width="100%" height="100%">
      ...
      <G id="feet" className="bodymap bodymap text-mw-gray" onPress={() => onPressMuscle?.('feet')}>
        <Path
      ...
      <G id="rectus-femoris" className="bodymap text-mw-red" data-force-highlight="true">
        <Path
          id="rectus-femoris"
...
export { SVGComponent as MaleFrontBodyMapMuscle }
