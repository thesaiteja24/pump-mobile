  ...
  return (
    ...
    >
      <BaseCard.Header
        ...
        subtitle={formatDistanceToNow(new Date(workout.startTime), { addSuffix: true })}
      />
      ...
      <BaseCard.Footer className="flex-col items-start gap-0">
        {/* Social Interactions */}
        ...
        {recentComments.length > 0 && (
          <Pressable
            className="w-full rounded-2xl bg-neutral-200 p-4 dark:bg-neutral-800"
