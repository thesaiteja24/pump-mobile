...
export const UserFitnessGoalsModal = forwardRef<BaseModalHandle, Props>((_, ref) => {
...
UserFitnessGoalsModal.displayName = 'UserFitnessGoalsModal'


export default UserFitnessGoalsModal
