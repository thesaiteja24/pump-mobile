...
export const UserSubscriptionPaywallModal = forwardRef<BaseModalHandle, Props>(
  (
    {
...
UserSubscriptionPaywallModal.displayName = 'UserSubscriptionPaywallModal'
export default UserSubscriptionPaywallModal
