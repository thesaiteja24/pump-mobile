...
export async function getAllMetaService(resource: MetaResource): Promise<any[]> {
  try {
    const res = await client.get(getEndpoint(resource))
    const handled = handleApiResponse<any[]>(res)
...
export async function getMetaByIdService(resource: MetaResource, id: string): Promise<any> {
  try {
...
export async function createMetaService(resource: MetaResource, data: FormData): Promise<any> {
  try {
...
export async function deleteMetaService(resource: MetaResource, id: string): Promise<void> {
  try {
